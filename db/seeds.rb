...
(5..6).each do |i|
  ...
  #ma.atrs << a1
  h1 = Hst.create(value: 10+i , tstamp: Chronic.parse('today').to_i)
  a1.hsts << h1

  h2 = Hst.create(value: 1+i , tstamp: Chronic.parse('tomorrow').to_i)
  a1.hsts << h2

  h3 = Hst.create(value: 1+i , tstamp: Chronic.parse('this second').to_i)
  a1.hsts << h3

  h4 = Hst.create(value: 1+i , tstamp: Chronic.parse('this morning').to_i)
  a1.hsts << h4

  h5 = Hst.create(value: 1+i , tstamp: Chronic.parse('last week').to_i)
  a1.hsts << h5

  h6 = Hst.create(value: 1+i , tstamp: Chronic.parse('last month').to_i)
  a1.hsts << h6
